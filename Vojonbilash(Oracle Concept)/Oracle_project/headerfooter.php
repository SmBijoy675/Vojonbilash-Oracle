...
<body style=" margin:0;">
    <div style="display:flex; justify-content: space-between; align-items: center; width: 100%; position: fixed; background: #85C429; padding: 20px 0; top: 0;">
        ...
        <span style="font-size: 25px; font-family: Sans-serif; font-weight: bold;">
            <a href="homepage.php" style="color: black; text-decoration: none; padding: 15px; margin-right: 10px;">Home</a>
            <a href="login.php" style="color: black; text-decoration: none; padding: 15px; margin-right: 10px;">Login</a>
            <a href="registration.php" style="color: black; text-decoration: none; padding: 15px; margin-right: 10px;" >Registration</a>
        </span>
    </div>
